...
public class JsonRequestActivity extends Activity implements OnClickListener {
	...
	private void makeJsonObjReq() {
		...
		JsonObjectRequest jsonObjReq = new JsonObjectRequest(Method.GET,
				"http://android.compliance4all.com/Compliance4AllMain", null,
				new Response.Listener<JSONObject>() {

					@Override
					public void onResponse(JSONObject response) {
						Log.d("RESPONSEFROMJSONIS", response.toString());
	...
	private void makeJsonArryReq() {
		showProgressDialog();
		JsonArrayRequest req = new JsonArrayRequest("http://android.compliance4all.com/Compliance4AllMain",
				new Response.Listener<JSONArray>() {
					...
					@Override
					public void onErrorResponse(VolleyError error) {
						VolleyLog.d("RESPONSEFROMJSONIS", "Error: " + error.getMessage());
						hideProgressDialog();
					}
				});
